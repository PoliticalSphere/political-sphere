...
const p95 = summary.metrics?.http_req_duration?.percentiles?.['95'] || summary.metrics?.http_req_duration?.p(95);
if (typeof p95 !== 'number') fail('k6 summary missing http_req_duration p95');

const maxP95 = budgets.latency?.p95_ms;
if (typeof maxP95 === 'number' && p95 > maxP95) fail(`Latency p95 ${p95}ms exceeds budget ${maxP95}ms`);
