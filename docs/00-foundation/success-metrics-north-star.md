...
| :------------: | :-----: | :----------: | :----------------: | :----------: |
|  🔒 Internal   | `1.0.0` |  2025-10-29  | Product Leadership |  Quarterly   |
...
│ Month: October 2025                                        │
├─────────────────────────────────────────────────────────────┤
│ NORTH STAR: Citizen Engagement Score                       │
│ Current: 42% │ Target: 75% │ Progress: +12% MoM           │
├─────────────────────────────────────────────────────────────┤
│ PRIMARY KPIs                                               │
│ Civic Learning: 38% │ Target: 40% │ 🟢 On Track           │
│ Participation: 18% │ Target: 25% │ 🟡 Needs Attention     │
│ Retention: 58% │ Target: 65% │ 🟡 Needs Attention         │
├─────────────────────────────────────────────────────────────┤
│ SECONDARY KPIs                                             │
│ Accuracy: 93% │ Target: 95% │ 🟡 Close                    │
│ Accessibility: 98% │ Target: 100% │ 🟢 On Track           │
│ AI Trust: 76% │ Target: 80% │ 🟡 Close                    │
└─────────────────────────────────────────────────────────────┘
```
