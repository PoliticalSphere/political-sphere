...
- `/package.json`, `/package-lock.json`, `/pnpm-workspace.yaml`, `/nx.json`, `/tsconfig.base.json`
- `/.editorconfig`, `/.gitignore`, `/.gitattributes`
- `/.github/` (workflows, templates)
- `/.vscode/` (IDE settings)
- `/.lefthook/`, `/.lefthook.yml` (git hooks configuration)
- `/.blackboxrules` (AI governance rules - pairs with `.github/copilot-instructions/copilot-instructions.md`)
- `/vitest.config.js` (test runner configuration - workspace-level)
