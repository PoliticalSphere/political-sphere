...
function up(db) {
	log("info", "Running performance optimization migration up function", { migration: name });
  ...
  `);
	...
	log("info", "Performance optimization migration up function completed", { migration: name });
}
